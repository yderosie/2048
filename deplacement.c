...
void	in_right(t_env *e)
{
	...
	while (i > -1)
	{
		...
		while (j > -1)
		{
			if (e->tab[i][j] == e->tab[i][j + 1] && e->tab[i][j] != 0)
			{
				e->tab[i][j + 1] *= 2;
				e->tab[i][j] = 0;
			}
...
void	in_bot(t_env *e)
{
	...
	while (i > -1)
	{
		...
		while (j > -1)
		{
			if (e->tab[i][j] == e->tab[i + 1][j] && e->tab[i][j] != 0)
			{
				e->tab[i + 1][j] *= 2;
				e->tab[i][j] = 0;
			}
